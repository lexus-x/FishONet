"""v46: v44 + LoRA∩ToL denser + denser iNat∩ToL BioCLIP-2 merge on FROZEN leg.
...
B2_WF = float(os.environ.get('B2_WF', '2.5'))
B2_WL = float(os.environ.get('B2_WL', '2.0'))
B2_PROTO_FROZEN = os.environ.get('B2_PROTO_FROZEN', 'outputs/inat_tol_merged_b2_a05.pt')
B2_PROTO_LORA = os.environ.get('B2_PROTO_LORA', 'outputs/inat_tol_merged_b2lora_a0.5.pt')
...
for IMG_W in IMG_WEIGHTS:
    ...
    tag = f'v46_loratoldenser_w{IMG_W:g}_wf{B2_WF:g}_wl{B2_WL:g}_a05_f{SEEN_FRAC:g}_sink72' if abs(SEEN_FRAC-0.72)>1e-9 else f'v46_loratoldenser_w{IMG_W:g}_wf{B2_WF:g}_wl{B2_WL:g}_a05_sink72'
