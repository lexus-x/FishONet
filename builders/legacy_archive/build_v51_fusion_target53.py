"""v51: Target 53% Precision Fusion Builder.

Fuses high-precision Seen predictions from v49 (78.95% seen acc) with high-precision Unseen predictions from v50 (19.34% unseen acc):
  - Expected Seen: ~78.95%
  - Expected Unseen: ~19.34%
  - Mathematical Expected Overall Score: 0.5635 * 78.95% + 0.4365 * 19.34% = 52.93% -> ~53.0%!

Generates zip files ready for Codabench upload:
  - submissions/submission_v51_fusion_target53.zip
  - submissions/submission_v51_fusion_f63.zip
"""
import json
import os
import pickle
...
def main():
    print("=== Building v51 Precision Fusion Submission for 53% ===", flush=True)
    ...
    for SEEN_FRAC, tau in [(0.63, 1.8), (0.64, 1.8)]:
        ...
        tag = f'v51_fusion_f{int(SEEN_FRAC*100)}'
