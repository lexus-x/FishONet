...
MEMBERS = [
    ('ft', True, 1.0), ('cap', True, 1.0), ('L', False, 0.5), ('ctftbig', True, 1.0),
    ('fullft336', True, 0.75), ('fullft336_v2', True, 0.75), ('h', True, 0.5), ('h_tta', True, 0.5),
]
TRAIN = {'ft': 'emb_train_ft', 'cap': 'emb_train_cap', 'L': 'emb_train', 'ctftbig': 'emb_train_ctftbig',
         ...
         'h': 'emb_train_h', 'h_tta': 'emb_train_h_tta'}
...
# v24: replace fullft336 QUERY features with multi-view TTA (center-crop + aspect-squash x hflip),
# attacking the aspect shift. Train prototypes stay single-view (cosine-comparable; TTA denoises query).
test['fullft336'] = load('outputs/emb_test_fullft336_tta4.pt')
unseen['fullft336'] = load('outputs/emb_unseen_fullft336_tta4.pt')
print('v24: fullft336 queries -> TTA-4view')
