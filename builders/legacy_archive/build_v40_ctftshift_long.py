"""v40_long: ctftshift_long encoder + iNaturalist maxpool photo-bank leg on the UNSEEN route.
...
BANK_PATH = os.environ.get('BANK_PATH', 'outputs/inat_photo_bank_ctftshift_long.pt')
...
TRAIN = {'ctftshift': 'emb_train_ctftshift_long', 'ftshift': 'emb_train_ftshift',
...
for IMG_W in IMG_WEIGHTS:
    text_unseen_only = text_unseen_base + IMG_W * img_leg
    ...
    tag = f'v40_long_inat_maxpool_w{IMG_W:g}_sink72'
